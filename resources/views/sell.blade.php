...
<html>
    ...
    <head>
        ...
        <meta charset="UTF-8">
        <!-- Title-->
        <title>{{__('home.sell')}} | Masterpiece</title>
        <!-- Theme color-->
  ...
  <section class="relative overflow-hidden" id="header"> 
      ...
      <section class="pageWithHeader mb-32 relative z-40">
        <!-- header title-->
        <h1 class="font-bold title mb-32 p-4 text-center">{{__('home.sell')}}</h1>
        <div class="container px-4 mx-auto"> 
          <!-- header Description--><div   style="width: 100%; min-height:50rem;  border-radius:1rem;  background: #fff;padding: 2rem;box-shadow: 0 0 4rem #0005;" 
    ...
    font-weight: bold;">Provide us with your contact info and we will call you soon</p>
