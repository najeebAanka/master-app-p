...
<html lang="en">
                                    ...
                                    <div class="modal fade" id="CreateNewModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-lg" role="document">
                                            <div class="modal-content">
                                                <form class="form theme-form" method="post" action="{{url('admin/pages/insert')}}">
                                                    {{ csrf_field() }}
  ...
  <p>Create a new service with description in 3 languages</p>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                <?php
                                                $items = \App\Models\Page::where('id', '>', 0);
                                                ...
                                                foreach ($items as $item) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{$item->title_en}}-{{$item->title_ru}}-{{$item->title_ar}}</td>
                                                      
                                               
                                                        <td>
                                                            <form class="form theme-form" method="post" 
                                                                  action="{{url('admin/pages/delete')}}">
                                                                {{ csrf_field() }}
                                                                ...
                                                                <button class="btn btn-warning" type="button"
                                                                        ...
                                                                        >Edit title</button>
                                                                <a class="btn btn-secondary"  href="{{url('admin/single-page/'.$item->id)}}"
                                                                        >Edit contents</a>
                                                                                ...
                                                                                <div class="card-body">
                                                                                    <div class="row">
                                                                                        <div class="col-md-4">
                                                                                            <div class="mb-3">
                                                                                                <label class="form-label" for="exampleFormControlInput1">Name (English)</label>
                                                                                                <input value="{{$item->title_en}}" class="form-control" name="name_en" type="text" placeholder="Name...">
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="col-md-4">
                                                                                            <div class="mb-3">
                                                                                                <label class="form-label" for="exampleFormControlInput1">Name (Russian)</label>
                                                                                                <input  value="{{$item->title_ru}}"class="form-control" name="name_ru" type="text" placeholder="Name...">
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="col-md-4">
                                                                                            <div class="mb-3">
                                                                                                <label class="form-label" for="exampleFormControlInput1">Name (Arabic)</label>
                                                                                                <input value="{{$item->title_ar}}" class="form-control" name="name_ar" type="text" placeholder="Name...">
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
