                                    ...
                                    <div class="modal fade" id="CreateNewModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-lg" role="document">
                                            <div class="modal-content">
                                                <form class="form theme-form" method="post" action="{{url('admin/services/insert')}}">
                                                    {{ csrf_field() }}
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                <?php
                                                $items = \App\Models\ServiceItem::where('id', '>', 0);
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <form class="form theme-form" method="post" 
                                                                  action="{{url('admin/services/delete')}}">
                                                                {{ csrf_field() }}
                                                                ...
                                                                <button class="btn btn-warning" type="button"
                                                                        ...
                                                                        >Edit title</button>
                                                                <a class="btn btn-secondary"  href="{{url('admin/single-service/'.$item->id)}}"
                                                                        >Edit contents</a>
                                                            ...
                                                            <div class="modal fade" id="EditRowModal{{$item->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                                <div class="modal-dialog modal-lg" role="document">
                                                                    <div class="modal-content">
                                                                        <form class="form theme-form" method="post" action="{{url('admin/services/update')}}">
                                                                            {{ csrf_field() }}
                                                                                   <input type="hidden" name="id" value="{{$item->id}}" />
                                                                            <div class="modal-header">
