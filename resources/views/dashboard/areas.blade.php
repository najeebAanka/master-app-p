                                    ...
                                    <div class="modal fade" id="CreateNewModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-lg" role="document">
                                            <div class="modal-content">
                                                <form class="form theme-form" method="post" enctype="multipart/form-data" action="{{url('admin/areas/insert')}}">
                                                    {{ csrf_field() }}
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="mb-3">
                                                                        <label class="form-label" for="exampleFormControlInput1">Area photo</label>
                                                            ...
                                                            <div class="row">
                                                                <div class="col">
                                                                    <div class="mb-3">
                                                                        <label class="form-label" for="exampleFormControlSelect9">Emirate</label>
                                                                        <select  class="form-select digits"  name="city">
                                                                            <?php foreach (\App\Models\City::get() as $emirate) { ?>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                <?php
                                                $items = \App\Models\Area::where('id', '>', 0);

                                                $start = 0;
                                                if (isset($_GET['start']))
                                                    $start = $_GET['start'];
                                                if (isset($_GET['city']))
                                                    $items = $items->where('city', $_GET['city']);

                                                $total = $items->count();
                                                $items = $items->take(20)->offset($start)->orderBy('name_en')->get();
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <div class="modal fade" id="EditRowModal{{$item->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                                <div class="modal-dialog modal-lg" role="document">
                                                                    <div class="modal-content">
                                                                        <form class="form theme-form" method="post" enctype="multipart/form-data" action="{{url('admin/areas/update')}}">
                                                                            {{ csrf_field() }}
                                                                                   <input type="hidden" name="id" value="{{$item->id}}" />
                                                                            <div class="modal-header">
                                                                                <h5 class="modal-title" id="exampleModalLabel">New Area</h5>
