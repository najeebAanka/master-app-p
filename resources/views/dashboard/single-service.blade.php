...
$item  = \App\Models\ServiceItem::find(Route::input('id'));
$page_title = $item->name_en;
$lang = "en";
if (isset($_GET['lang']))
    $lang = $_GET['lang'];
?>
                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <h5>{{$item["name_".$lang]}} | page design</h5>
                                    </div>
                                      ...
                                      <div class="row">
                                                                <div class="col-md-12">
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <textarea id="editor1" class="form-control" name="content_{{$lang}}" type="text" placeholder="Content..." 
                                                                                  cols="30" rows="10">{{$item["content_".$lang]}}</textarea>
                                                                    </div>
                                                                </div>
